  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav">
        ...
        <a data-th-href="@{/kapcsolat}" class="nav-item nav-link active">Kapcsolat</a>
      </div>
      <div class="navbar-nav ms-auto">
        <a data-th-href="@{/bejelentkezes}" class="nav-item nav-link">Bejelentkezés</a>
...
<div class="container">
  ...
  <div class="row g-3 my-4">
    <div class="col-12 col-md-12 col-lg-12 col-xl-12 rounded-5 p-3 bg-dark">
      <h2>E-mail</h2>
      <p>Felveheti a kapcsolatot a weboldallal e-mailen keresztül az <a href="mailto:info@jegy.cc" target="_blank">info@jegy.cc</a> címen.</p>
      <p><a href="mailto:info@jegy.cc" target="_blank" class="btn btn-success">E-mail küldése</a></p>
    </div>
  </div>
</div>
</body>
